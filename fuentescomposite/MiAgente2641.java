...
public class MiAgente2641 extends Agent{
    ...
    private class miTicker extends TickerBehaviour{
        ...
        public miTicker(Agent a, long intervalo){ //Paso al constructor el intervalo de tiempo
            super(a, intervalo);
            minticks = 0;
        }
        ...
        protected void onTick() {
            ...
            int nticks = getTickCount(); // obtenemos el numero de ticks desde el último reset. Nº interno con el que controlas el nº de repeticiones
            minticks++;
            if (nticks == 5) {
